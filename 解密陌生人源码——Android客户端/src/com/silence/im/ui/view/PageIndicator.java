package com.silence.im.ui.view;
...
public class PageIndicator extends View implements
	...
	public PageIndicator(Context context, AttributeSet attrs) {
		...
		final int defaultSelectedColor = getResources().getColor(
				R.color.default_page_indicator_selected_color);
		...
		setSelectedColor(a.getColor(R.styleable.PageIndicator_selectedColor,
				defaultSelectedColor));
		setFadeDelay(a.getInteger(R.styleable.PageIndicator_fadeDelay,
				defaultFadeDelay));
		setFadeLength(a.getInteger(R.styleable.PageIndicator_fadeLength,
				defaultFadeLength));

		Drawable background = a
				.getDrawable(R.styleable.PageIndicator_android_background);
